...
RUN cd ./image_storage && gdown 1LMEtbhydAXg5CkHtgqn4tiGw8J-HVQTv && unzip nft_finder_image_folder.zip "nft_finder_image_folder/*"
# Clean up
RUN rm nft_finder_image_folder.zip
